...
Dans le menu latéral, l'utilisateur peut générer des données selon une loi initiale. Il peut décider des paramètres de la loi, et d'une perturbation à ajouter. Il peut ensuite ajouter une tolérance en termes de somme des résidus au carré, et allouer un budget de temps pour l'algorithme de modélisation. 

![image](https://maelfabien.github.io/assets/images/s4d_5.png)

Les données sont ensuite généréées automatiquement, et l'algorithme de modélisation est lancé. La meilleure loi identifiée, les paramètres et le temps d'exécution sont alors affichés.
