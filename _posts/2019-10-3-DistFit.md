...
En perturbant `y` et en ré-exécutant le code ci-dessus,


# Application Web Interactive

Afin de comprendre l'influence du seuil défini, des paramètres de départ de la loi générée ou de pouvoir la perturber 
