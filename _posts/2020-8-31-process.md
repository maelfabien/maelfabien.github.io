...
<div class="timeline">
  ...
  <div class="container left">
    <div class="content">
      <h2>August 2020</h2>
      <p>Participated and won the <a href="https://www.createchallenge.org/">International Create Challenge</a> organized at Idiap with an assistive device named SoundMap that uses Head-Related Transfer Function (HRTFs) to provide directional feedbacks.</p>
    </div>
  </div>
  <div class="container right">
    <div class="content">
