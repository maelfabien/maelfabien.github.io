...
If we have 5'000 words of vocabulary and we fit our model on it, the output of the network should be a 5'000 $$ \times $$ 5'000 matrix, and within each position the probability that these words appear together.
