...
![image](https://maelfabien.github.io/assets/images/vision_50.png)
...
![image](https://maelfabien.github.io/assets/images/vision_51.png)

### c. 2D Miror about Y axis
...
$$ Ap = b $$ whew :
- $$ A = \sum_i J^T(x_i)J(x_i) $$ the Hessian
...
$$ E_{WLS} = \sum_i {\Sigma_i}^2 \mid \mid r_i \mid \mid $$ . If the $$ \delta_i $$ are fixed, the solution to apply is : $$ p = ( \sum^T A^T A \Sigma)^-1 \simga^T Ab $$ with $$ \Sigma $$ a matix containing for each observation the noise level.
