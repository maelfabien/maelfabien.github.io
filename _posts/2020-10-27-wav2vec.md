...
## What to do with this discrete representation?
...
## Fine-tuning for downstream speech recognition task
...
Finally, authors mention thatself-training is likely complimentary to pre-training and their combination may yield even better results. However, it is not
...
# 5. What is really embedded in this speech representation?
