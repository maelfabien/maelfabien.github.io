---
published: true
title: Wav2Vec and Wav2Vec 2.0 tutorial
collection: ml
layout: single
author_profile: true
read_time: true
...
Wav2Vec 2.0 leverages self-supervised training. This method has gained some attention in NLP and CV.
...
## Self-supervices learning in speech

Authors of Wav2Vec 2.0 at Facebook AI propose a self-supervised framework to learn a representation of speech from raw audio data.
