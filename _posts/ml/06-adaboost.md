...
![image](https://maelfabien.github.io/myblog/images/stumps.png){:height="80%" width="80%"}

Well, the answer is... 12 ! It might seem surprising, but it's rather easy to understand.

![image](https://maelfabien.github.io/myblog/images/stumps_12.png){:height="80%" width="80%"}
...
![image](https://maelfabien.github.io/myblog/images/split.png)
...
![image](https://maelfabien.github.io/myblog/images/classifier.png)

Do you see any way to potentially improve the classifier ?

By adding weights $$ \alpha^t $$ on each classifier !

![image](https://maelfabien.github.io/myblog/images/classifier_full.png)
...
![image](https://maelfabien.github.io/myblog/images/optim_stump.png)
...
![image](https://maelfabien.github.io/myblog/images/face_detect.png)
