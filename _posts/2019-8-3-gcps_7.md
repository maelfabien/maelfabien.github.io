...
![image](https://maelfabien.github.io/assets/images/gcp_99.png)

This is only a basic exploration in GeoViz, but the tool is really powerful.

# BigQuery ML

More than 60% of ML models in Google operate on structure data. CNNs and LSTMs represent up to 35 % of the rest.

As a general guideline, here's the most simple type of model you should consider in each case :

![image](https://maelfabien.github.io/assets/images/gcp_100.png)
...
![image](https://maelfabien.github.io/assets/images/gcp_101.png)
...
![image](https://maelfabien.github.io/assets/images/gcp_102.png)
...
![image](https://maelfabien.github.io/assets/images/gcp_103.png)
