...
![image](https://maelfabien.github.io/assets/images/ec2_spark.png)
...
![image](https://maelfabien.github.io/assets/images/Spark_Wget.png)
...
![image](https://maelfabien.github.io/assets/images/Spark_Extract1.png) 


The terminal of your Slave nodes will look like this :  
![image](https://maelfabien.github.io/assets/images/Spark_Extract2.png) 
...
```
![image](https://maelfabien.github.io/assets/images/Spark_copy.png)
...
Example :  
![image](https://maelfabien.github.io/assets/images/Spark_default.png)
...
For example :  
![image](https://maelfabien.github.io/assets/images/Spark_env.png)
...
Example :  
![image](https://maelfabien.github.io/assets/images/Spark_env2.png)
...
$ ./start-master.sh
```
![image](https://maelfabien.github.io/assets/images/Spark_master_launch.png)
...
![image](https://maelfabien.github.io/assets/images/Spark_master_web.png)
...
```
Here's an example :  
![image](https://maelfabien.github.io/assets/images/Spark_slave_launch.png)

Once all slave nodes are running, reload your master browser page. All Worker nodes will be attached to the Master 1 :   
![image](https://maelfabien.github.io/assets/images/Spark_master_web2.png)
...
![image](https://maelfabien.github.io/assets/images/Spark_master1_down.png)

Check the transfer of Master : 

Then execute :
![image](https://maelfabien.github.io/assets/images/Spark_master2_cat.png)

You'll see that Zookeeper elected Master 2 as the primary master :  
![image](https://maelfabien.github.io/assets/images/Spark_master2_election.png)

From the Spark UI of Master 2, you'll see that all slave nodes are now attached :  
![image](https://maelfabien.github.io/assets/images/Spark_master2_web.png)
