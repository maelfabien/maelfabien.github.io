...
df
```
![image](https://maelfabien.github.io/myblog/images/Tab1.png){:height="20%" width="20%"}
...
plt.show()
```
![image](https://maelfabien.github.io/myblog/images/Graph1.png){:height="60%" width="60%"}
...
plt.show()
```
![image](https://maelfabien.github.io/myblog/images/Graph2.png){:height="60%" width="60%"}
...
![image](https://maelfabien.github.io/myblog/images/bias.png){:height="50%" width="50%"}
...
![image](https://maelfabien.github.io/myblog/images/Graph3.png){:height="50%" width="50%"}
...
![image](https://maelfabien.github.io/myblog/images/Graph4.png){:height="50%" width="50%"}
...
![image](https://maelfabien.github.io/myblog/images/Graph5.png){:height="60%" width="60%"}
