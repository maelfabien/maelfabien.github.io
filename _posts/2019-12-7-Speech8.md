---
published: true
title: Introduction to Voice Computing in Python
collection: ml
layout: single
...
These notes are a summary of "An Introduction to Voice Computing in Python" by Jim Schwoebel. This books covers the key concepts of Voice Computing, recording, playing, storing and converting audio, extracting features, creating ML models on top, generating data...
...
The collection can be passive (no response expected from the program, in the background), or active.
