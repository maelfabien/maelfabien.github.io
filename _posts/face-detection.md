...
Cascade classifier, or namely cascade of boosted classifiers working with haar-like features, is a special case of ensemble learning, called boosting. It typically relies on [Adaboost](https://maelfabien.github.io/myblog/ml/06-adaboost/) classifiers (and other models such as Real Adaboost, Gentle Adaboost or Logitboost).
...
![image](https://maelfabien.github.io/myblog/images/haar.png)
...
![image](https://maelfabien.github.io/myblog/images/haar_selection.png)
...
![image](https://maelfabien.github.io/myblog/images/haar_rectangles.png)
...
![image](https://maelfabien.github.io/myblog/images/haar_region.png)
...
![image](https://maelfabien.github.io/myblog/images/steerable.png)
...
![image](https://maelfabien.github.io/myblog/images/cascade.png)
...
![image](https://maelfabien.github.io/myblog/images/test_face.png)
...
![image](https://maelfabien.github.io/myblog/images/test_face_output.png)
...
![image](https://maelfabien.github.io/myblog/images/dlib_chain.png)
...
![image](https://maelfabien.github.io/myblog/images/gradient-kernels.jpg)
...
plt.show()
```
![image](https://maelfabien.github.io/myblog/images/grad.png)
...
![image](https://maelfabien.github.io/myblog/images/hog_1.png)

- the angle is larger than 160°. In such case, we consider that the pixel contributed proportionally to 160° and to 0°.

![image](https://maelfabien.github.io/myblog/images/hog_2.png)

The HOG looks like this for each 8x8 cell :

![image](https://maelfabien.github.io/myblog/images/hog.png)
...
![image](https://maelfabien.github.io/myblog/images/face_hog.png)
...
![image](https://maelfabien.github.io/myblog/images/face_dlib.png)
