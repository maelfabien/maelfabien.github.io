...
![image](https://maelfabien.github.io/assets/images/cnn_1.png)

The **step size** is simply the amount by which we shift the filter at each step. 

![image](https://maelfabien.github.io/assets/images/cnn_2.png)
...
- otherwise, we convolve the image with the objective to keep the original dimension. This is called : `padding='same'` in Keras. Filter window stays at **valid** position inside input map.

![image](https://maelfabien.github.io/assets/images/cnn_3.png)
...
![image](https://maelfabien.github.io/assets/images/cnn_5.png)
...
![image](https://maelfabien.github.io/assets/images/cnn_4.png)
...
Implementing a CNN in Keras can be done the following way. Start off by importing the following package :
...
We can the build the model in Keras :
...
- the loss (here, binary crossentropy)
- the metric to use (our probelm is balanced, so accuracy is just fine)
...
> **Conclusion** : CNNs are nowadays key elements in computer vision. If you have a question, don't hesitate to comment the article.
