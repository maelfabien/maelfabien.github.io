...
La tokenisation cherche à transformer un texte en une série de tokens individuels. Dans l'idée, chaque token représente un mot, et identifier des mots est une tâche relativement simple. Mais comment gérer en français des exemples tels que: "J'ai froid". Il faut que le modèle de tokenisation sépare le "J'" comme étant un premier mot.
